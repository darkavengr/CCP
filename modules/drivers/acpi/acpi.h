...
#define EBDA_START_ADDRESS 0x100000+KERNEL_HIGH
#define RDSP_START_ADDRESS 0xE0000+KERNEL_HIGH
#define RDSP_END_ADDRESS 0xFFFFF+KERNEL_HIGH
	
#define POWERBUTTON_OFF	0
#define POWERBUTTON_SLEEP	1
#define POWERBUTTON_REBOOT	2

#define POWERBUTTON_DEFAULT	POWERBUTTON_SLEEP

...
.PHONY: drivers
drivers:
	./gendrivelist   modules/drivers/pci modules/drivers/console modules/drivers/pci modules/drivers/pic
	echo $(OBJFILES)

	for f in  modules/drivers/pci modules/drivers/console modules/drivers/pci modules/drivers/pic; do make -C $$f;done

	for f in  modules/drivers/ata modules/drivers/clock modules/drivers/floppy modules/drivers/keyb modules/drivers/null modules/drivers/pic modules/drivers/pit modules/drivers/serialio modules/filesystems/fat modules/binfmt/elf32; do make -C $$f;done
...
#
initrd:
	./gen_initrd  obj/i386 bin/i386/INITRD.SYS  modules/drivers/ata modules/drivers/clock modules/drivers/floppy modules/drivers/keyb modules/drivers/null modules/drivers/pic modules/drivers/pit modules/drivers/serialio modules/filesystems/fat modules/binfmt/elf32
